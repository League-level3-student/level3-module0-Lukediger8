...
public class Firework {
	...
	public Firework() {
		...
		for (int i = 0; i < j.length; i++) {
			j[i] = new Spark(fireworkdisplay.HEIGHT, fireworkdisplay.WIDTH/2);
		}
	}
	...
	public void launch() {
		...
		for (int i = 0; i < j.length; i++) {
			j[i].x = fireworkdisplay.HEIGHT;
			j[i].y = fireworkdisplay.WIDTH/2;
		}
	}
